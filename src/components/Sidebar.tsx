...
export const Sidebar: React.FC<SidebarProps> = ({ onPageChange, currentPage }) => {
  ...
  return (
    <>
      ...
      <div className="fixed left-0 top-0 h-screen bg-white border-r border-gray-200 z-40 transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:w-64" style={{
